...
/* 
  ...
  https://create.arduino.cc/cloud/things/5e3b2e19-0d34-4ffa-bab7-c8d04eb0dc12 
...
#define SHOW_RESULT_TIME 2000

String REGION_EU = "EU";
String REGION_SWISS = "SWISS";
String REGION_UNKNOWN = "UNKNOWN";
String REGION_WAITING = "WAITING";

long lastMeaningfulResult = 0;
...
void loop() {
  ...
  long now = millis();
  if (lastMeaningfulResult && (now - lastMeaningfulResult >= SHOW_RESULT_TIME)) {
      lastMeaningfulResult = 0;
      region = REGION_WAITING;
      drawWelcomeScreen("Waiting...");
      rgb.on(255, 0, 0);
  }
